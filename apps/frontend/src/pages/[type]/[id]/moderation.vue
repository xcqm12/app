  ...
  <div>
    <section class="universal-card">
      ...
      <div v-else-if="isUnderReview(project)">
        <p>
          BBSMC 内容社区管理员团队会努力审核所有已提交的项目。 通常，新项目将在 24 到 48
          小时内审核完毕。请记住，较大的项目（尤其是模组包）可能需要更多时间审核。
          某些节假日或活动也可能导致延迟，具体取决于社区管理员的空闲时间。 如果 BBSMC
          社区管理员对您有任何问题或疑虑，他们会在下面留言。
        </p>
      </div>
    ...
    <section id="messages" class="universal-card">
      ...
      <p>
        这是与 BBSMC
        社区管理员的私人对话页面,他们可能会向您发送有关此项目的问题的消息.仅当您提交资源以供审核时才会显示此对话。
      </p>
      <ConversationThread
        v-if="thread"
        :thread="thread"
