...
SMTP_HOST=${SMTP_HOST}
SMTP_FROM_NAME=${SMTP_FROM_NAME:-BBSMC}
SMTP_FROM_USER=${SMTP_FROM_USER:-noreply}
SMTP_FROM_DOMAIN=${SMTP_FROM_DOMAIN:-bbsmc.org.cn}

SITE_VERIFY_EMAIL_PATH=verify-email
SITE_RESET_PASSWORD_PATH=reset-password
